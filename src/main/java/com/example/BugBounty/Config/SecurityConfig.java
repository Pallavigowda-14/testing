...
import com.example.BugBounty.Security.AuthTokenFilter;
import com.example.BugBounty.Security.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/github/**").permitAll()  // ✅ Allow GitHub API calls
                        .requestMatchers("/**").permitAll()  // ✅ TEMP: Allow all for testing
